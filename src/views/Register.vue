                ...
                <div class="container">
                    ...
                    <form class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                <label for="txtEmail">Email do tutor</label>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <label for="sltGender">Género</label>
                                        <select id="sltGender" required>
                                            <option value=""></option>
                    ...
                    <form class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" id="txtContact" required>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="form-group">
                ...
                <div class="container">
                    ...
                    <form class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="sltGrau">Licenciatura</label>
                                <select id="sltGrau" required>
                                    <option value=""></option>
                                </select>
                            </div>
