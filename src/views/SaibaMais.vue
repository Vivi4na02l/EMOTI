<template>
    <div class="SaibaMais">
        ...
        <div colspan=2 id="sectionFAQ">
            ...
            <table style="width: 100%;" class="my-5"><tr><td></td><td rowspan=2>
					<div id="pinkImage" class="text-left">
						<img src="../assets/images/curvesBackground/saibaMaisPink.png" width="100%">
					</div>
			</td></tr><tr>
			<td colspan=2 class="col-8">
                <form @submit.prevent="addQuestion()">
                    <div id="createQuestion">
                        <h1>Faça uma <p style="color: #dd65b0; display: inline;">pergunta</p>!</h1>
                        <textarea rows="10" cols="100" class="mt-5" id="txtQuestion" v-model="newQuestion"></textarea>
...
<style lang="scss" scoped>
    ...
    .SaibaMais #FAQ, .SaibaMais #opened {
        display: block;
        flex-direction: column;
        align-items: center;
    }
    ...
    .SaibaMais #openAnswer {
        border-radius: 50px;
    } .SaibaMais #openAnswer, .SaibaMais #btnSeeAll, #btnSend {
        font-family: Baloo_2 extrabold;
        background-color: #FFFFFF;
        color: #DD65B0;
        border-color: #DD65B0;
    } .SaibaMais #btnSeeAll:hover, #btnSend:hover {
